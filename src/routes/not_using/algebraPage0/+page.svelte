<script lang="ts">
    ...
    import { makeAlgebraFSM } from '$lib/data/pure_algebra/algebraFSM';
    import { makeAlgebraMarkov } from '$lib/data/pure_algebra/algebraMarkov';
    import { algebraicArrayDataset } from '$lib/data/pure_algebra/algebraicArrayDataset';
